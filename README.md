...
- коды F_F (счётчик, увеличиваем на 1 когда нужен новый код): 8
...
- toolbar с заголовком "Br Schedule"
    - меню "три точки"
        ...
        - пункт "Переименовать пользователя"; при нажатии открывается диалог переименования текущего выбранного работника
- F1F выпадающий список с пунктами:
    - пользователь 1 (выбран по умолчанию)
    - пользователь 2
    - ...
    - пользователь 10
- F2F блок настройки графика конкретного работника:
    - F4F блок с кнопками (горизонтальный):
        ...
        - F8F кнопка-иконка в виде замка; при нажатии на неё кнопки F5F и F6F дизейблятся/раздизебляются циклически (заблокированы → разблокированы → заблокированы → ...)
